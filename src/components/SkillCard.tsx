...
export default function SkillCard({
    ...
    return (
        <>
            <div className="w-fit bg-secondary/10 px-3 py-2 md:py-2 md:px-4 rounded-lg border flex items-center gap-2 border-secondary/5 group-hover:opacity-25 hover:!opacity-100 cursor-pointer transition-all">
