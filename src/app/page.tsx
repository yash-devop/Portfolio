    ...
    <>
      <div>
        <div className="tracking-tighter pt-20">
          ...
          <p className="text-[16px] py-5 leading-relaxed text-secondary dark:text-primaryDark">&ldquo;Crafting designs and building products that should be able to solve<br />
            some of your problems and help make your life 
            uncomplicated + aesthetically pleasing &ldquo;</p>
        </div>
      </div>
